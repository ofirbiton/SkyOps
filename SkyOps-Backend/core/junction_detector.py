...
def highlight_dense_skeleton_nodes(merged_image):
    """
    Identifies skeleton points with at least 3 neighbors - marked as a junction in yellow.
    """
    ...
    merged_image[yellow_nodes] = [255, 255, 0] 
...
def refine_yellow_nodes(junctions_highlighted):
    ...
    for label_idx in range(1, num_labels + 1):
        ...
        selected_idx = dep.np.argmin(region[0])  
        y, x = region[0][selected_idx], region[1][selected_idx]
        refined_junctions[y, x] = [255, 255, 0]  
